...
class Organization extends Model
{
    ...
    {
        return $this->hasmany('App\Address', 'address_organizations', 'organization_recordid');
    }

    public function taxonomy()
    {
        return $this->belongsTo('App\Taxonomy', 'organization_x_chapter', 'taxonomy_recordid');
    }
}